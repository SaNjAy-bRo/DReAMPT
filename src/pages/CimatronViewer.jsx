...
const KeyBenefits = [
  {
    ...
    "desc": "Review mold and die designs, tool builds, and EDM and CNC processes."
  },
  {
    "icon": "/images/3/images/detailed-instructions.png",
    "title": "Detailed instructions",
    "desc": "Analyze 3D CAD data to generate tool build instructions and view plans for CNC machining."
  },
  {
    "icon": "/images/3/images/faster-delivery.png",
    "title": "Improved efficiency",
    "desc": "Cimatron Viewer inspects native Cimatron data and eliminates the need to manage numerous data files."
  },
  {
    "icon": "/images/3/images/better-collaboration.png",
    "title": "Better collaboration",
    "desc": "Increased access to information improves communication and collaboration between departments, reduces error, and increases productivity."
  }
];
const GridFeatures = [];
const Capabilities = [];

const CimatronViewer = () => {
  return (
      ...
      <section className="relative bg-[#eceff3] pt-24 pb-20 lg:pt-32 lg:pb-32 border-b border-slate-200 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-[55%]">
            <Reveal><h1 className="font-heading text-4xl font-extrabold leading-tight text-white drop-shadow-lg sm:text-5xl lg:text-6xl tracking-tight">Cimatron Viewer</h1></Reveal>
            <Reveal delay={100}><div className="w-20 h-1.5 bg-brand-orange mt-6 rounded-full shadow-sm"></div></Reveal>
            <Reveal delay={200}><h2 className="mt-8 text-2xl font-bold text-white drop-shadow-md lg:text-3xl">Simplify workflows and share information easily across teams</h2></Reveal>
            <Reveal delay={300}><p className="mt-5 text-lg text-zinc-100 drop-shadow max-w-2xl font-medium leading-relaxed">Cimatron Viewer simplifies design and process reviews for mold and die drawings, parts, assemblies, and CNC operations.</p></Reveal>
