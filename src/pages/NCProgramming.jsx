...
const KeyBenefits = [
  {
    ...
    "desc": "A hybrid CAD environment and variety of design tools help quickly prepare solid models for production"
  },
  {
    "icon": "/images/3/images/powerful-machining.png",
    "title": "Specialized machining strategies",
    "desc": "Generate safe and accurate toolpath, and take advantage of specialized strategies for milling and drilling"
  },
  {
    "icon": "/images/3/images/simulation.png",
    "title": "Advanced simulation",
    "desc": "Machine with confidence using simulation representing machine kinematics, fixtures, and workpieces"
  }
];
const GridFeatures = [
  {
    "img": "/images/3/images/cimatron-nc-programming-01.jpg",
    "title": "Integrated CAD capabilities",
    "desc": "A hybrid CAD environment enables designers to easily repair models and modify designs using a combination of wireframe, surface, and solid functions. Specialized design tools make it easy to apply drafts and rounds, remove or modify rounds, cap holes and slots, and extend surfaces. Tools that detect and analyze changes to geometry help increase confidence in designs."
  },
  {
    "img": "/images/3/images/cimatron-nc-programming-02.jpg",
    "title": "5-axis programming",
    "desc": "Improve programming efficiency with specialized machining strategies that allow CNC programmers to retain complete control over all 5-axis machining operations. Cimatron provides strategies for machining complex blades, impellers, blisks, turbines, and more. A comprehensive library of proven post processors for 5-axis machine tools and controllers helps ensure accuracy and efficiency."
  },
  {
    "img": "/images/3/images/cimatron-nc-programming-03.jpg",
    "title": "Plate machining and automated drilling",
    "desc": "Cimatron CAM provides a rough pocketing strategy that simplifies high-speed machining (HSM) operations and the 2.5-axis machining of open and closed pockets. Rapid material removal makes machining open pockets more productive, while templates that help automate pocket and profiling operations increase programming efficiency. Automated drilling functions, including hole and stock recognition, cut programming time by up to 90 percent."
  }
];
const Capabilities = [
  {
    "img": "/images/3/images/cimatron-nc-programming-04.jpg",
    "title": "Efficient roughing, flawless finishing",
      ...
      <section className="relative bg-[#eceff3] pt-24 pb-20 lg:pt-32 lg:pb-32 border-b border-slate-200 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-[55%]">
            <Reveal><h1 className="font-heading text-4xl font-extrabold leading-tight text-white drop-shadow-lg sm:text-5xl lg:text-6xl tracking-tight">Cimatron CAM Programming</h1></Reveal>
            <Reveal delay={100}><div className="w-20 h-1.5 bg-brand-orange mt-6 rounded-full shadow-sm"></div></Reveal>
            <Reveal delay={200}><h2 className="mt-8 text-2xl font-bold text-white drop-shadow-md lg:text-3xl">Generate safe, accurate, and efficient toolpath </h2></Reveal>
            <Reveal delay={300}><p className="mt-5 text-lg text-zinc-100 drop-shadow max-w-2xl font-medium leading-relaxed">Cimatron CAM provides powerful tools for the efficient programming of 2.5-axis to 5-axis CNC machine tools, including specialized strategies for machining molds, plates, dies, and discrete parts.</p></Reveal>
